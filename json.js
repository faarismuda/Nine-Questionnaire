const json = {
    ...
    "description": {
     "default": "Dear Responden yang Terhormat, perkenalkan saya M Cahyo Priambodo saat ini sedang melakukan survey terhadap pengguna mobile banking. Apabila Anda berusia antara 17 hingga 63 tahun serta menggunakan layanan mobile banking (Seperti BCA (BCA Mobile), Mandiri (Livin’ by Mandiri), BNI (BNI Mobile Banking), BSI (BSI Mobile), BRI (BRImo), CIMB (Octo Mobile), Permata (Permata Mobile X), dsb), saya memohon kesediaan Anda untuk berpartisipasi dalam pengisian kuesioner penelitian ini. Berikut ketentuan pengisian kuesioner ini: Durasi pengisian kuesioner 10-15 menit. Tidak ada jawaban benar atau salah. Responden diharapkan untuk mengisi kuesioner secara jujur dan sesuai dengan keadaan sebenarnya. Keseluruhan informasi yang diperoleh dari kuesioner ini bersifat RAHASIA, tidak akan disalahgunakan dan hanya digunakan untuk kepentingan penelitian dan publikasi. Dengan mengisi kuesioner ini, Anda telah berkontribusi dalam pengembangan ilmu pengetahuan dan membantu layanan digital banking agar lebih memahami penggunanya. Terima kasih atas perhatian, kerjasama, serta kesediaan Anda untuk berkontribusi dalam riset ini. Salam, M Cahyo Priambodo (Tim Riset ACTC UCN 2023)",
     "id": "Dear Responden yang Terhormat, perkenalkan saya M Cahyo Priambodo saat ini sedang melakukan survey terhadap pengguna mobile banking. Apabila Anda berusia antara 17 hingga 63 tahun serta menggunakan layanan mobile banking (Seperti BCA (BCA Mobile), Mandiri (Livin’ by Mandiri), BNI (BNI Mobile Banking), BSI (BSI Mobile), BRI (BRImo), CIMB (Octo Mobile), Permata (Permata Mobile X), dsb), saya memohon kesediaan Anda untuk berpartisipasi dalam pengisian kuesioner penelitian ini. Berikut ketentuan pengisian kuesioner ini: Durasi pengisian kuesioner 10-15 menit. Tidak ada jawaban benar atau salah. Responden diharapkan untuk mengisi kuesioner secara jujur dan sesuai dengan keadaan sebenarnya. Keseluruhan informasi yang diperoleh dari kuesioner ini bersifat RAHASIA, tidak akan disalahgunakan dan hanya digunakan untuk kepentingan penelitian dan publikasi. Dengan mengisi kuesioner ini, Anda telah berkontribusi dalam pengembangan ilmu pengetahuan dan membantu layanan digital banking agar lebih memahami penggunanya. Terima kasih atas perhatian, kerjasama, serta kesediaan Anda untuk berkontribusi dalam riset ini. Salam, M Cahyo Priambodo (Tim Riset ACTC UCN 2023)."
    },
    "completedHtml": "<h3>Terima Kasih!</h3>",
     ...
     },
     {
      ...
      "elements": [
       ...
       },
       {
        ...
        "choices": [
         {
          "value": "gender_laki_laki",
          "text": "Laki-laki"
         },
         {
          "value": "gender_perempuan",
          "text": "Perempuan"
         }
        ]
       },
